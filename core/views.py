            ...
            if form.is_valid():
                ...
                if use_default_shipping:
                    ...
                    if is_valid_form([shipping_address1, shipping_country, shipping_zip]):
                        ...
                        messages.info(
                            self.request, "please fill in the required shipping fields")
                        return redirect('core:checkout')
                ...
                if same_billing_address:
                    ...
                    if is_valid_form([billing_address1, billing_country, billing_zip]):
                        ...
                        messages.info(
                            self.request, "please fill in the required billing fields")
...
class PaymentView(View):
    ...
    def post(self, *args, **kwargs):
        ...
        try:
            ...
            # assigment the payment to the order
            ...
            # body.e.json_body
            # err = body.get('error', {})
            # message.error(self.request, f"{err.get('message')}")
            ...
            # yourself an email
            messages.error(
                self.request, "Something went wrong. You were not chargred please try again")
            return redirect("/")
        ...
        if self.request.method == "POST":
            ...
            if form.is_valid():
                try:
                    ...
                    order.save()
                    messages.success = (
                        self.request, "Successfuly added coupon")
                    return redirect('core:checkout')
                except ObjectDoesNotExist:
                    messages.info(
